...
async function main() {
    ...
    console.log(
        'If 404: repo may be private. Add VITE_GITHUB_TOKEN (ou GITHUB_TOKEN) ao .env com um Personal Access Token.'
    )
    console.log(
        'Local file check: node scripts/test-release-notes-fetch.mjs ' + VERSION + ' --local'
    )
}
