...
export const DropZone = ({ layoutMode, activeDropZone, componentId }: DropZoneProps) => {
  return (
    <>
      ...
      <DropIndicator
        position="bottom"
        isActive={activeDropZone?.id === componentId && activeDropZone?.position === 'bottom'}
      />
      {layoutMode === 'horizontal' && (
        <>
          <DropIndicator
            position="left"
            isActive={activeDropZone?.id === componentId && activeDropZone?.position === 'left'}
          />
          <DropIndicator
            position="right"
            isActive={activeDropZone?.id === componentId && activeDropZone?.position === 'right'}
          />
        </>
      )}
    </>
