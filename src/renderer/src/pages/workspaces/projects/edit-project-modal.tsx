      ...
      <IGRPDialogContentPrimitive className="overflow-hidden max-h-[80svh] sm:max-w-[700px] lg:max-w-[800px] max-w-4xl">
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-6">
          <div className="space-y-4">
              ...
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center">
                  {formik.values.icon ? (
                    ...
                    <div className="text-gray-400 text-xs text-center">{t('noIcon')}</div>
                  )}
                </div>
            ...
            <div className="space-y-2">
              ...
              <IGRPTextAreaPrimitive
                ...
                onChange={(e) => formik.setFieldValue('config.description', e.target.value)}
                onBlur={formik.handleBlur}
              ...
              {formik.touched.config && formik.errors.config && (
                <p className="text-xs text-destructive">
                  {typeof formik.errors.config === 'object' && 'description' in formik.errors.config
            ...
            {/* Theme Color */}
            <div className="space-y-2">
              <IGRPLabelPrimitive htmlFor="themeColor">{t('themeColor')}</IGRPLabelPrimitive>
          ...
          <IGRPDialogFooterPrimitive>
            ...
            <IGRPButtonPrimitive type="submit" disabled={isSubmitting || !formik.isValid}>
