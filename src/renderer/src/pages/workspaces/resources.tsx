...
const Resources = () => {
  ...
  const filteredProjects = allProjects.filter(
    (project) =>
      (project.name && project.name.toLowerCase().includes(projectSearchQuery.toLowerCase())) ||
      (project.framework &&
    ...
    <div className="space-y-6">
      ...
      >
        {projectViewMode === 'grid' ? (
          ...
          <ProjectList projects={filteredProjects} workspaceId={workspace.id} services={services} />
        )}
      </ResourceSection>
