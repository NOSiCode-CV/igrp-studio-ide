  ...
  return (
    <IGRPDialogPrimitive open={open} onOpenChange={() => onOpenChange?.(!open)} modal>
      <IGRPDialogContentPrimitive className="max-w-[500px]">
        <IGRPDialogHeaderPrimitive>
          <IGRPDialogTitlePrimitive>{t('workspace.createTitle')}</IGRPDialogTitlePrimitive>
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="space-y-2">
            <IGRPLabelPrimitive htmlFor="slug">{t('workspace.slug')}</IGRPLabelPrimitive>
            <IGRPInputPrimitive
              id="slug"
              value={slug}
          ...
          <div className="flex justify-end pt-4">
            <IGRPButtonPrimitive onClick={handleCreate} disabled={isCreating || !directoryPath}>
