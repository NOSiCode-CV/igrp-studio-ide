          ...
          <IGRPDropdownMenuPrimitive>
            ...
            <IGRPDropdownMenuContentPrimitive align="end" className="w-48">
              ...
              {getServiceUrl(service) && (
                <IGRPDropdownMenuItemPrimitive onClick={() => onOpenInBrowser(service)}>
      ...
      <div className="space-y-1 text-xs text-gray-600 dark:text-gray-300">
        ...
        {service.image && (
          <div className="truncate">
            <span className="text-gray-500 dark:text-gray-400">Image:</span> {service.image}
          </div>
        )}
      </div>
      ...
      levelServices.forEach((service, index) => {
        ...
        newNodes.push({
          ...
          data: {
            ...
            services,
            onEditService: (service: ServiceInfo) => handleEditServiceRef.current?.(service),
            onDeleteService: (service: ServiceInfo) => handleDeleteServiceRef.current?.(service),
            onOpenInBrowser: (service: ServiceInfo) => handleOpenInBrowserRef.current?.(service)
          },
      ...
      <div className="flex items-center justify-center h-96">
        <IGRPCardPrimitive className="w-96">
          ...
          <IGRPCardContentPrimitive>
            ...
            <IGRPButtonPrimitive onClick={handleRefresh} variant="outline" className="w-full">
        ...
        <IGRPCardPrimitive className="w-96">
          ...
          <IGRPCardContentPrimitive>
            <p className="text-sm text-gray-600">
              No Docker services found in this workspace. Add services to see them in the diagram.
            </p>
          </IGRPCardContentPrimitive>
        </IGRPCardPrimitive>
      </div>
