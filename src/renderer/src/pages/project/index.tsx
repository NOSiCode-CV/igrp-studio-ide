    ...
    <div className="space-y-4">
            ...
            {previewUrl ? (
              ...
              <>
                ...
                <div className="text-sm text-gray-600">
                  ...
                  <div className="text-xs text-gray-400">{t('recommendedSize')}</div>
                </div>
                <IGRPButtonPrimitive
                  variant="outline"
                  size="sm"
      ...
      <div className="space-y-2">
        ...
        >
          ...
          >
            <IGRPRadioGroupItemPrimitive value="frontend" id="frontend" className="sr-only" />
            <IGRPLabelPrimitive
              htmlFor="frontend"
            ...
            >
              ...
              <div>
                <div>{t('frontend')}</div>
                <div className="text-sm text-gray-500">{t('frontendDescription')}</div>
              </div>
            </IGRPLabelPrimitive>
          </div>
          <div
          ...
          >
            <IGRPRadioGroupItemPrimitive value="backend" id="backend" className="sr-only" />
            <IGRPLabelPrimitive
              htmlFor="backend"
              className="flex items-center gap-2 cursor-pointer"
            >
              ...
              <div>
                <div>{t('backend')}</div>
                <div className="text-sm text-gray-500">{t('backendDescription')}</div>
              </div>
            </IGRPLabelPrimitive>
          </div>
        </IGRPRadioGroupPrimitive>
          ...
          <form onSubmit={formik.handleSubmit} className="mx-6 mb-6">
            ...
            <IGRPDialogFooterPrimitive>
              <div className="flex w-full justify-between mt-4">
                {step > 1 ? (
                  <IGRPButtonPrimitive type="button" variant="outline" onClick={handleBack}>
