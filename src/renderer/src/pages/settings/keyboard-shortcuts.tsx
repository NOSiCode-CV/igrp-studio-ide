  ...
  const shortcutData: ShortcutGroup[] = React.useMemo(() => [
    ...
    },
    {
      ...
      shortcuts: [
        ...
        { name: t('switchToNextTab'), shortcut: SHORTCUTS.SWITCH_TO_NEXT_TAB },
        { name: t('switchToPreviousTab'), shortcut: SHORTCUTS.SWITCH_TO_PREVIOUS_TAB },
        { name: t('jumpToSpecificTab'), shortcut: SHORTCUTS.JUMP_TO_SPECIFIC_TAB },
    ...
    },
    {
      ...
      shortcuts: [
        ...
        { name: t('openShortcutHelp'), shortcut: SHORTCUTS.OPEN_SHORTCUT_HELP },
      ],
    },
  ], [t]);
