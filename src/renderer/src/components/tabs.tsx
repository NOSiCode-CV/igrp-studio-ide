...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn('inline-flex h-9 items-center  p-1 text-muted-foreground border-b', className)}
    {...props}
  />
))
...
export {
  Tabs as IGRPTabs,
  TabsList as IGRPTabsList,
  TabsTrigger as IGRPTabsTrigger,
  TabsContent as IGRPTabsContent
}
