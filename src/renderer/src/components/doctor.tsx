                            ...
                            <IGRPTableRowPrimitive key={index}>
                              ...
                              <IGRPTableCellPrimitive className="py-3">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span
                                    className={tool.success ? 'text-green-600' : 'text-red-600'}
                                  >
                                    {tool.success ? 'OK' : tool.required ? 'Required' : 'Optional'}
                                  </span>
                                </div>
                              </IGRPTableCellPrimitive>
            ...
            {results && (
              <div className="mt-6 pt-4 border-t">
                <div className="flex items-center justify-between text-sm text-muted-foreground">
                  <span>
                    Total tools checked: {results.length} • Successful:{' '}
                    {results.filter((t) => t.success).length} • Required missing:{' '}
                    {results.filter((t) => t.required && !t.success).length}
                  </span>
