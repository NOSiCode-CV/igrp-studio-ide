...
export function GitCommitsSidebar({ basePath, onSelectCommit }: GitCommitsSidebarProps) {
        ...
        <IGRPTooltipPrimitive>
          <IGRPTooltipTriggerPrimitive asChild>
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-normal truncate max-w-[180px]">{commit.message}</span>
            </div>
          </IGRPTooltipTriggerPrimitive>
          <IGRPTooltipContentPrimitive>
            <p>{commit.message}</p>
