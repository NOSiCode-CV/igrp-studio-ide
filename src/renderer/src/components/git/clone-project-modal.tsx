...
import { IGRPInputPrimitive, IGRPInputPassword } from '@igrp/igrp-framework-react-design-system'
    ...
    <IGRPDialogPrimitive open={open} onOpenChange={setOpen}>
      <IGRPDialogContentPrimitive className="sm:max-w-[700px] lg:max-w-[650px] max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
        <IGRPDialogHeaderPrimitive className="">
          <IGRPDialogTitlePrimitive className="">{t('cloneProject')}</IGRPDialogTitlePrimitive>
          <IGRPDialogDescriptionPrimitive />
        </IGRPDialogHeaderPrimitive>
        <div className="flex-1 overflow-hidden flex flex-col">
          <IGRPTabsPrimitive defaultValue="url" className="w-full flex-1 flex flex-col">
            <IGRPTabsListPrimitive className="grid w-full grid-cols-2">
              <IGRPTabsTriggerPrimitive value="url">{t('repositoryUrl')}</IGRPTabsTriggerPrimitive>
              ...
              <div className="grid gap-6 py-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2 grid gap-2">
                    <IGRPLabelPrimitive htmlFor="project-url" className="text-muted-foreground">
                      {t('repositoryUrl')}
                    </IGRPLabelPrimitive>
                    <IGRPInputPrimitive
                      id="project-url"
                ...
                <div className="grid gap-2">
                  ...
                  <IGRPTabsPrimitive value={authType} onValueChange={setAuthType}>
                    <IGRPTabsListPrimitive className="grid w-full grid-cols-3">
                      <IGRPTabsTriggerPrimitive value="none">{t('none')}</IGRPTabsTriggerPrimitive>
                    ...
                    <IGRPTabsContentPrimitive value="basic" className="mt-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="grid gap-2">
                          <IGRPLabelPrimitive htmlFor="username" className="text-muted-foreground">
                            {t('username')}
                          </IGRPLabelPrimitive>
                        ...
                        <div className="grid gap-2">
                          <IGRPLabelPrimitive htmlFor="password" className="text-muted-foreground">
                            {t('password')}
                          </IGRPLabelPrimitive>
                          <div className="relative">
                    ...
                    <IGRPTabsContentPrimitive value="token" className="mt-4">
                      <div className="grid gap-2">
                        <IGRPLabelPrimitive htmlFor="token" className="text-muted-foreground">
                          {t('token')}
                        </IGRPLabelPrimitive>
                        <div className="relative">
                          <Key className="absolute left-2 top-2.5 h-4 w-4 text-muted-foreground" />
