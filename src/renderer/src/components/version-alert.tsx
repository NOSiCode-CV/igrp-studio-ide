...
export function VersionAlert({
  ...
  const enabledVersionAlert = import.meta.env.RENDERER_VITE_ENABLE_VERSION_ALERT === 'true' || false
        ...
        <IGRPDialogPrimitive open={showChangelog} onOpenChange={setShowChangelog}>
          ...
          <IGRPDialogContentPrimitive className="max-w-2xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="flex justify-end gap-2 pt-4 border-t">
              <IGRPButtonPrimitive variant="outline" onClick={() => setShowChangelog(false)}>
                Close
              </IGRPButtonPrimitive>
              <IGRPButtonPrimitive
                onClick={() => {
