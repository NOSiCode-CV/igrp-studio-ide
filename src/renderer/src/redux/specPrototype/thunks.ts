...
export const loadPrototypeFiles = (basePath: string) => async (dispatch: Dispatch) => {
    if (!basePath) return
    try {
...
export const openPrototypeFile = (basePath: string, path: string) => async (dispatch: Dispatch) => {
...
export const refreshDevStatus = (basePath: string) => async (dispatch: Dispatch) => {
    if (!basePath) return
    try {
...
export const startPrototypeDev = (basePath: string) => async (dispatch: Dispatch) => {
    if (!basePath) return
    try {
...
export const stopPrototypeDev = (basePath: string) => async (dispatch: Dispatch) => {
    if (!basePath) return
    try {
...
export const loadPrototypeSnapshots = (basePath: string) => async (dispatch: Dispatch) => {
    if (!basePath) return
    try {
 ...
 */
export const subscribePrototypeEvents =
    () =>
