      ...
      <IGRPPopoverContentPrimitive className="w-[425px]">
        <IGRPTabsPrimitive defaultValue="dataType">
          <IGRPTabsListPrimitive className="grid w-full grid-cols-2">
            <IGRPTabsTriggerPrimitive value="dataType">{t('Data Type')}</IGRPTabsTriggerPrimitive>
                  ...
                  <div className="grid grid-cols-3 gap-2 col-span-2">
                    <div className="items-center space-x-2">
                      ...
                      <IGRPSwitchPrimitive
                        ...
                        onCheckedChange={(checked) => handleChange('enum', checked)}
                      />
                    </div>
                    <div className="items-center space-x-2">
                      ...
                      <IGRPSwitchPrimitive
                        ...
                        onCheckedChange={(checked) => handleChange('const', checked)}
                      />
                    </div>
                  </div>
                ...
                <>
                  ...
                  <div className="items-center gap-4">
                    ...
                    <IGRPInputPrimitive
                      ...
                      className="col-span-2 h-6 text-sm"
                      onChange={(e) => handleChange('maximum', parseFloat(e.target.value))}
                    />
                  </div>
                  <div className="items-center gap-4">
                    <IGRPLabelPrimitive htmlFor="multipleOf" className="text-sm">
                      {t('multipleOf')}
                    </IGRPLabelPrimitive>
                    <IGRPInputPrimitive
                      id="multipleOf"
                      ...
                      className="col-span-2 h-6 text-sm"
                      onChange={(e) => handleChange('multipleOf', parseFloat(e.target.value))}
                    />
                  </div>
                </>
              )}
          ...
          <IGRPTabsContentPrimitive value="jsonSchema">
            <MonacoEditor content={JSON.stringify(field, null, 2)} onChange={handleChangeEditor} />
          </IGRPTabsContentPrimitive>
        </IGRPTabsPrimitive>
      </IGRPPopoverContentPrimitive>
    </IGRPPopoverPrimitive>
