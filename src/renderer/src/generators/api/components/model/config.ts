...
// TABLES FORMAT
export const getTablesColumns = ({ selectors, attributes, models, currentModel }): { [value: string]: IColumnsTabelProps[] } => {
    ...
    return {
        ...
        relations: [
            { key: 'relationType', name: 'Relation Type', type: 'select', options: relationTypeOptions, width: '16%' },
        ...
        crud: [
            ...
            { key: 'disabledMethods', name: 'Disabled Methods', type: 'multiSelect', options: disabledOptions, width: '75%' }
        ],
        indexes: [
