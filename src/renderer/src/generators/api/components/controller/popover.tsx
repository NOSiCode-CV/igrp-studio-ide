                ...
                {!isBoolean && (
                  <div className="flex flex-1 gap-2">
                    {['emun', 'const'].map((field) => (
                      <div key={`${field}-${index}`} className="flex items-center gap-4">
                        <Label htmlFor={`${field}-${index}`}>{toInitCap(field)}</Label>
                        <Switch
                          id={`${field}-${index}`}
                          onCheckedChange={(checked) => changeValue(field, index, checked)}
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        placeholder=">=0"
                        value={row?.['minimunm'] || ''}
                        onChange={(ev) => changeValue('minimunm', index, ev.target.value)}
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        placeholder=">=0"
                        value={row?.['maximum'] || ''}
                        onChange={(ev) => changeValue('maximum', index, ev.target.value)}
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        onChange={(ev) => changeValue('multipleOf', index, ev.target.value)}
                      />
                    </div>
                  </div>
                )}
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      className="h-8"
                      value={row?.['default'] || ''}
                      onChange={(ev) => changeValue('default', index, ev.target.value)}
                    />
                  </div>
                  {!isBoolean && (
                    <>
                      <div className="space-y-1">
                        ...
                        <Input
                          ...
                          className="h-8"
                          value={row?.['pattern'] || ''}
                          onChange={(ev) => changeValue('pattern', index, ev.target.value)}
                        />
                      </div>
                      ...
                      <div className="col-span-2 space-y-1">
                        ...
                        <Input
                          ...
                          className="h-8"
                          value={row?.['examples'] || ''}
                          onChange={(ev) => changeValue('examples', index, ev.target.value)}
                        />
                      </div>
                    </>
                  )}
