            ...
            <IGRPTabsPrimitive defaultValue="validations">
              ...
              <IGRPTabsContentPrimitive value="validations" className="space-y-4">
                ...
                <div className="flex flex-1 gap-2">
                  {['required', 'before', 'after'].map((field) => (
                  ...
                  <div className="space-y-2">
                    ...
                    <IGRPInputPrimitive
                      ...
                      onChange={(ev) => {
                        ...
                        if (value >= 0) {
                          changeValue('minLength', index, value)
                        }
                      }}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <IGRPInputPrimitive
                      ...
                      onChange={(ev) => {
                        const value = Number(ev.target.value)
                        if (value >= 0) {
                          changeValue('maxLength', index, value)
                        }
                      }}
                    />
                  </div>
                  <div className="space-y-2">
                    <IGRPLabelPrimitive htmlFor="regex">{t('regex')}</IGRPLabelPrimitive>
                    <IGRPInputPrimitive
                      id="regex"
