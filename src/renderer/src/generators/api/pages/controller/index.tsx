      ...
      <div className="space-y-4 p-4">
        <IGRPCardPrimitive>
          <IGRPCardHeaderPrimitive>
            ...
            <IGRPCardDescriptionPrimitive>{t('controllerDefinition')}</IGRPCardDescriptionPrimitive>
          </IGRPCardHeaderPrimitive>
          <IGRPCardContentPrimitive>
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4">
              <div className="flex flex-col gap-3 md:col-span-2 space-y-2">
                <IGRPInputAddOn
                  ...
                  classNameLabel={cn(
                    'w-full',
                    formik.touched.path && formik.errors.path && 'border-red-500'
                  )}
                />
                {formik.errors.path && formik.touched.path && (
                  <p className="text-xs text-red-500">{formik.errors.path}</p>
                )}
              </div>
              <TextInput
                id={'actionName'}
