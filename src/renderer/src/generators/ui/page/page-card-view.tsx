            ...
            <div className="flex items-center">
              {hasChild && (
                <IGRPCollapsibleTriggerPrimitive asChild>
                  <IGRPButtonPrimitive variant="ghost" size="icon" className="h-5 w-5 p-0 mr-1">
                    <ChevronRight
                      className={cn(
              ...
              <div className="flex items-center gap-2 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-medium text-sm truncate">{description || pageName}</div>
                ...
                {subPages.map((subpage) => (
                  ...
                  >
                    <div className="flex items-center gap-1 flex-1 min-w-0">
                      <span className="truncate">{subpage.description || subpage.pageName}</span>
