...
export function DuplicatePageModal({
    ...
    const initialValues = {
        ...
        description: originalContent?.description
            ? `${originalContent.description} Copy`
            : '',
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, actions) => {
            try {
                ...
                createGitCommit(
                    basePath,
                    'Added Form Validation and page duplicate'
                );
                ...
                >
                    <div className="grid grid-cols-1 gap-4">
                        <TextInput
                            id="description"
                            label={
                                isPage ? t('pageTitle') : t('componentTitle')
                            }
                            ...
                            placeholder={
                                isPage ? 'Todo List (Copy)' : 'Todo Item (Copy)'
                            }
                            isRequired
                        />
                        <TextInput
                            ...
                            placeholder={
                                isPage ? 'TodoListCopy' : 'TodoItemCopy'
                            }
                            isRequired
                        />
                        {isPage && (
