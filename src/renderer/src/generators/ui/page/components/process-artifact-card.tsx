...
import { getNormalizedFormKey, getFormKeyType } from '../utils/form-key-utils'
          ...
          <div className="flex flex-col items-end space-y-2">
            ...
            <IGRPDropdownMenuPrimitive>
              <IGRPDropdownMenuTriggerPrimitive asChild>
                <IGRPButtonPrimitive variant="ghost" size="sm" className="h-6 w-6 p-0">
              ...
              <IGRPDropdownMenuContentPrimitive align="end" className="w-56">
                ...
                <IGRPDropdownMenuItemPrimitive
                  onClick={() => onCopyFromLegacyVersion(selectedProcess, artifact)}
                >
      ...
      <IGRPCardContentPrimitive className="space-y-2">
        ...
        {stepProcessFound ? (
          <IGRPButtonPrimitive
            ...
            className="w-full"
            variant="outline"
            onClick={() => onPageClick?.(convertFileTreeToPageDefinition(stepProcessFound))}
          >
