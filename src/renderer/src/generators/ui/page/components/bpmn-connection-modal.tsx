  ...
  const handleTestConnection = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        igrpToast({ type: 'error', content: `API connection test failed: ${result.message}` })
      }
    } catch (error) {
    ...
    <IGRPDialogPrimitive open={isOpen} onOpenChange={handleClose}>
      ...
      >
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            <IGRPLabelPrimitive htmlFor="token">Access Token (Optional)</IGRPLabelPrimitive>
            <IGRPInputPrimitive
              id="token"
              type="password"
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <IGRPLabelPrimitive htmlFor="isActive">Active Configuration</IGRPLabelPrimitive>
          </div>
        </div>
