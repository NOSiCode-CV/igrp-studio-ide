...
export const ComputeLabelConfigPopover: React.FC<
    ComputeLabelConfigPopoverProps
> = ({
    fields,
    functionOptions,
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <h4 className="font-medium text-sm mb-1">
                            Compute Label Configuration
                        </h4>
                        <p className="text-xs text-muted-foreground">
                            Select a field or custom function to compute the
                            label for this list
                        </p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <IGRPCombobox
                            ...
                            onChange={(value) =>
                                handleFieldChange(value as string)
                            }
                        />
                        {fields.length === 0 && (
                            <p className="text-xs text-amber-600">
                                No fields available. Add fields to the form
                                first.
                            </p>
                        )}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <IGRPCombobox
                            ...
                            onChange={(value) =>
                                handleFunctionChange(value as string)
                            }
                        />
    ...
    // return \`Item #\${index + 1}: \${item.title}\`;
                        ...
                        {functionOptions.length === 0 && (
                            <p className="text-xs text-amber-600">
                                No custom functions available. Create one in
                                Custom Code.
                            </p>
                        )}
                    </div>
