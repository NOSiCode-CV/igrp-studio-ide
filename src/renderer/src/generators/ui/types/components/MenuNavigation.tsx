      ...
      return (
        ...
        >
          <BoxField
            ...
            className={cn('left-0 right-auto opacity-0 group-hover/tab-menu:opacity-100')}
          >
            <button
              {...rest}
              key={child.id}
            ...
            >
              ...
              <ChevronRight
                className={cn(
                  ...
                  activeSection === child.id ? 'text-primary' : 'text-muted-foreground'
                )}
              />
            </button>
          </BoxField>
        ...
        <IGRPCardPrimitive className="shadow-sm py-0 gap-0">
          <IGRPCardHeaderPrimitive className="px-4  pt-2">
            <div className="flex items-center justify-between">
              ...
              <IGRPBadgePrimitive variant="outline" className="font-normal text-xs">
                {content || 'New'}
              </IGRPBadgePrimitive>
            </div>
          </IGRPCardHeaderPrimitive>
