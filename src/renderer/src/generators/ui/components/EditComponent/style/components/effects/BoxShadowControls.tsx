      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center">
          <label className="flex items-center gap-1.5">
            ...
            />
            <span className="text-[9px] text-gray-500">Inside shadow</span>
          </label>
        </div>
        <div className="grid grid-cols-2 gap-1">
          <div className="space-y-0.5">
            <label className="text-[9px] text-gray-500">Offset X</label>
            <input
              type="number"
              value={shadow.x}
          ...
          <div className="space-y-0.5">
            <label className="text-[9px] text-gray-500">Offset Y</label>
            <input
              type="number"
              value={shadow.y}
        ...
        <div className="grid grid-cols-2 gap-1">
          ...
          <div className="space-y-0.5">
            <label className="text-[9px] text-gray-500">Spread</label>
            <input
              type="number"
              value={shadow.spread}
