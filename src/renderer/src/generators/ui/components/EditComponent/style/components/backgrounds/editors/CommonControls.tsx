  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-1">
        ...
        <div className="space-y-0.5">
          <label className="text-[9px] text-gray-500">Position</label>
          <select
      ...
      <div className="grid grid-cols-2 gap-1">
        <div className="space-y-0.5">
          <label className="text-[9px] text-gray-500">Repeat</label>
          <select
        ...
        <div className="space-y-0.5">
          <label className="text-[9px] text-gray-500">Attachment</label>
          <select
            value={background.attachment}
            onChange={(e) => onChange({ ...background, attachment: e.target.value })}
            className="w-full px-1.5 py-0.5 text-[9px] bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded border-0 focus:ring-2 focus:ring-blue-500"
          >
      ...
      <div className="space-y-0.5">
        <label className="text-[9px] text-gray-500">Blend Mode</label>
        <select
