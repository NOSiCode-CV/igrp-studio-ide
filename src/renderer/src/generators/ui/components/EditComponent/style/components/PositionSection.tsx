...
export function PositionSection() {
  ...
  const positionTypes: { value: PositionType; label: string; description: string }[] = [
    ...
    <div className="space-y-2">
      ...
      {positionType !== 'static' && (
        <>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              <h3 className="text-[10px] font-medium text-gray-700 dark:text-gray-300">Offset</h3>
              <button
          ...
          {/* Z-Index */}
          <div className="space-y-1.5">
            <label className="text-[10px] font-medium text-gray-700 dark:text-gray-300">Z-Index</label>
            <input
              type="number"
              value={zIndex}
