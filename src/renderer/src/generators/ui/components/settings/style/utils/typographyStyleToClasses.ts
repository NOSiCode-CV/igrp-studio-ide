// utils/typographyStyleToClasses.ts
...
export function typographyStyleToClasses(typography: TypographyStyle): string {
  ...
  if (typography.letterSpacing) {
    classes.push(
      getSpacingClass(typography.letterSpacing.value, typography.letterSpacing.unit, 'tracking')
    )
  }
  ...
  if (typography.wordSpacing) {
    classes.push(
      getSpacingClass(typography.wordSpacing.value, typography.wordSpacing.unit, 'word-spacing')
    )
  }
