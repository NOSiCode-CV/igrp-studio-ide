import { Edit2, Plus, Timer, Trash2 } from 'lucide-react'
import { useEffect, useRef, useState } from 'react'
import { useTranslation } from 'react-i18next'
import { type TransitionValue, timingFunctions, transitionProperties } from './types'
...
export function TransitionControls({ transitions, onTransitionsChange }: TransitionControlsProps) {
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <div className="flex items-center gap-1">
                            <input
                                ...
                                value={transition.duration}
                                onChange={(e) =>
                                    updateTransition(index, 'duration', e.target.value)
                                }
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="text-xs font-medium text-gray-700 dark:text-gray-300">
                                {transition.property.charAt(0).toUpperCase() +
                                    transition.property.slice(1)}
                            </div>
                        ...
                        <div className="flex items-center gap-1">
                            <div className="relative">
                                ...
                                {editingIndex === index && (
                                    <TransitionEditor transition={transition} index={index} />
                                )}
                            </div>
                            <button
                                onClick={() => removeTransition(index)}
