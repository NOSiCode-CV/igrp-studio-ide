...
export const backgroundSizes = ['cover', 'contain', '100% 100%', 'auto']
...
export const backgroundRepeats = ['no-repeat', 'repeat', 'repeat-x', 'repeat-y', 'space', 'round']

export const backgroundAttachments = ['scroll', 'fixed', 'local']
