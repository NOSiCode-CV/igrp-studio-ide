import { ArrowDown, ArrowRight, Lock, RefreshCw, Unlock } from 'lucide-react'
import type React from 'react'
import { useEffect, useState } from 'react'
import { useTranslation } from 'react-i18next'
import type { SectionProps, SizeSytle, SizeValue } from '../types'
                ...
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="space-y-1.5">
                        <SizeInput
                            ...
                            onChange={(minHeight) =>
                                setSizeState((prev) => ({ ...prev, minHeight }))
                            }
                            label="Min Height"
                        />
                        <SizeInput
                            ...
                            onChange={(maxHeight) =>
                                setSizeState((prev) => ({ ...prev, maxHeight }))
                            }
                            label="Max Height"
                        />
                    </div>
