    ...
    <div className="space-y-2">
      <div className="grid grid-cols-2 gap-1">
        <div className="space-y-1">
          <label className="text-xs text-gray-500 dark:text-gray-400">{t('direction')}</label>
          <select
            value={direction}
        ...
        <div className="space-y-1">
          <label className="text-xs text-gray-500 dark:text-gray-400">{t('densePacking')}</label>
      ...
      <div className="grid grid-cols-2 gap-1">
        <div className="space-y-1">
          <label className="text-xs text-gray-500 dark:text-gray-400">{t('columns')}</label>
          <input
            type="number"
            min="1"
            value={columns}
        ...
        <div className="space-y-1">
          <label className="text-xs text-gray-500 dark:text-gray-400">{t('rows')}</label>
          <input
            type="number"
            min="1"
            value={rows}
      ...
      <div className="grid grid-cols-2 gap-1">
        <div className="space-y-1">
          <label className="text-xs text-gray-500 dark:text-gray-400">{t('alignItems')}</label>
          <select
            value={alignItems}
        ...
        <div className="space-y-1">
          <label className="text-xs text-gray-500 dark:text-gray-400">{t('justifyItems')}</label>
          <select
            value={justifyItems}
      ...
      <div className="space-y-1">
        <label className="text-xs text-gray-500 dark:text-gray-400">{t('gap')}</label>
