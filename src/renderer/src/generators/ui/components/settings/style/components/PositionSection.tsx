import { Lock, Move, RefreshCw, Unlock } from 'lucide-react'
import { useEffect, useState } from 'react'
import { useTranslation } from 'react-i18next'
import type { PositionStyle, PositionType, PositionValue, SectionProps, Side } from '../types'
                    ...
                    <div className="space-y-1.5">
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                onClick={() =>
                                    updatePositionStyle({
                                        linked: !positionStyle.linked
                                    })
                                }
                                className={`p-0.5 rounded ${
                                    positionStyle.linked
                                ...
                                <div key={side} className="space-y-0.5">
                                    ...
                                    <div className="flex items-center gap-1">
                                        <input
                                            ...
                                            onChange={(e) =>
                                                updatePosition(side, 'value', e.target.value)
                                            }
                                        ...
                                        <select
                                            ...
                                            onChange={(e) =>
                                                updatePosition(side, 'unit', e.target.value)
                                            }
