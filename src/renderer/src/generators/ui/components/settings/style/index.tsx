      ...
      {classes && (
        <>
          <p className="text-sm text-muted-foreground pb-2">
            These classes are generated by the style editor and applied to the current component.
            You can use them to control visibility, layout, or other behaviors dynamically.
          </p>

          <code className="block text-xs mt-1 bg-background p-2 rounded-sm border">{classes}</code>
        </>
      )}
    </div>
  )
