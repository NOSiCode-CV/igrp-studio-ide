...
import { Code, FunctionSquare, Info, Type, Zap } from 'lucide-react'
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>
                    Use <strong>Name</strong> to insert the state variable, or <strong>Set</strong>{' '}
                    to insert the setter function
                </span>
            </div>
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Info className="w-4 h-4" />
                <span>
                    Click &quot;Insert Type&quot; to add the type name and import statement to your
                    editor
                </span>
            </div>
