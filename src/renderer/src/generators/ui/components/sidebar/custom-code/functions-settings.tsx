  ...
  return (
    ...
    >
      ...
      <IGRPSidebarContentPrimitive className="gap-4 p-2">
        ...
        <IGRPTabsPrimitive defaultValue={formik ? 'props' : 'states'} onValueChange={setActiveTab}>
          <IGRPTabsListPrimitive
            className={cn('grid w-full grid-cols-5', !formik ? 'grid-cols-4' : '')}
          >
            {formik && <IGRPTabsTriggerPrimitive value="props">Props</IGRPTabsTriggerPrimitive>}
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <CheckboxInput
                      ...
                      onChange={(checked) => {
                        formik.setFieldValue('returnValue.isNullable', checked)
                      }}
                      className="flex-1"
                    />
                  </div>
...
export const FunctionArguments = ({
  ...
  return (
    <div className="flex flex-col gap-2">
                  ...
                  {arg.isFunction && (
                    <div className="mt-6 p-4 border rounded-lg bg-white">
                      <div className="flex items-center justify-between mb-4">
                        <h4 className="font-medium">Function Configuration</h4>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        {arg?.functionParameters &&
                          arg.functionParameters.map((param, paramIndex) => (
                            <div
                              key={param.id}
                            ...
                            >
                              <div className="flex-1">
                                <IGRPInputPrimitive
                                  ...
                                  value={param.name}
                                  onChange={(e) =>
                                    updateFunctionParameter(arg.id, param.id, {
                                      name: e.target.value
                                    })
                                  }
                                />
      ...
      <IGRPButtonPrimitive onClick={addArgument} className="w-full" variant="outline" type="button">
