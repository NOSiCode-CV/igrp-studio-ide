                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="mt-1 text-sm text-orange-700 dark:text-orange-300">
                                    Unable to connect to remote API. Switch to &quot;Local&quot;
                                    mode to view your locally generated BPMN processes, or configure
                                    an API connection in the &quot;API Configuration&quot; tab.
                                </p>
                            </div>
                        </div>
                    </IGRPCardContentPrimitive>
                        ...
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                            {filteredLocalProcesses.map((process, index) => {
                                ...
                                const processConfigFile = lastVersion?.children?.find(
                                    (child) =>
                                        !child.isDirectory && child.content?.type === 'process'
                                )
                                const processDescription =
                                    processConfigFile?.content?.description ||
