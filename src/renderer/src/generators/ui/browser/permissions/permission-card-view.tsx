...
export function PermissionCardView({
    ...
    return (
        ...
        >
            ...
            <div>
                <div className="flex items-start justify-between gap-2">
                    <div className="flex min-w-0 items-center gap-2">
                        <ChevronRight className="h-4 w-4 shrink-0 text-slate-500 transition-all group-hover:translate-x-0.5 group-hover:text-emerald-400" />
                        <div className="flex min-w-0 items-center gap-1.5">
                            <Key className="h-3.5 w-3.5 shrink-0 text-purple-400 transition-colors group-hover:text-emerald-400" />
                ...
                <div className="mt-1.5 pl-6">
                    <p className="truncate font-mono text-xs font-medium tracking-tight text-slate-400">
                        {entry.key}
                    </p>
            ...
            <div className="mt-4 flex items-center justify-between border-t border-slate-800/40 pl-6 pt-3">
                {entry.usageCount > 0 ? (
                    <button
                        type="button"
                        onClick={(e) => {
                        ...
                        className="flex items-center gap-1 text-xs font-semibold text-purple-400 transition-colors hover:text-purple-300 hover:underline"
                    >
                        {entry.usageCount}{' '}
                        {entry.usageCount === 1
                ...
                <div className="flex items-center gap-1.5">
                    {inUse && (
                        <span className="rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2 py-0.5 font-mono text-[10px] text-emerald-400/80">
